...
{    
    ...
    if(empty($path)) {            
        ...
        //updating the table
        $result = mysqli_query($mysqli, "UPDATE images SET imagename='$path' WHERE id='4' ");
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="col-12 float-left mt-4">
        <div class="container">
            <form action="contactimg.php?id=<?$id?>" method="POST" class="form-group" enctype="multipart/form-data">
                <label> 
                    Əlaqə şəkili dəyiş
                </label>
