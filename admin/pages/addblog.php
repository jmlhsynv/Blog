...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="col-12 float-left mt-4">
        <div class="container">
            <form action="add.php" method="post" name="form1" class="" enctype="multipart/form-data"> 
                <div class="form-group">
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Article Title" name="title">
                </div>
                <div class="form-group">
                    <input type="file" class="form-control " name="uploaded_file">
                </div>
                <div class="form-group">
                    <textarea name="article" placeholder="Enter Article Content" rows="20" style="width: 100%;" class="form-control"></textarea>
                </div>
