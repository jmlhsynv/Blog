...
{    
    ...
    if(empty($path)) {            
        ...
        //updating the table
        $res = mysqli_query($mysqli, "UPDATE images SET imagename='$path' WHERE id ='2'");
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="col-12 float-left mt-4">
        <div class="container">
            <form action="editimage1.php?id=<?$id?>" method="POST" class="form-group" enctype="multipart/form-data">
                <label> 
                    Blog şəkili dəyiş
                </label>
