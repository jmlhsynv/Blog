...
{   $text= $_POST['text'];
    ...
    if(empty($text)) {            
        ...
        //updating the table
        $result = mysqli_query($mysqli, "UPDATE info SET infotext='$text' WHERE id='3' ");
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="col-12 float-left mt-4">
        <div class="container">
            <form action="abouttxt.php?id=<?$id?>" method="POST" class="form-group" enctype="multipart/form-data">
                <label> 
                    Haqqımda məlumatı dəyiş
                </label>
